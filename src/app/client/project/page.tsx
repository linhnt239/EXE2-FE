            ...
            <TableBuilder
                extraButtons={[
                    <div className="flex items-center gap-4" key="1">
                        <Link href={NKRouter.client.project.create()}>
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: (record) => {
                            return (
                                <Link href={NKRouter.client.project.detail(record.id)}>
                ...
                extraFilter={[`user.id||${FilterComparator.EQUAL}||${id}`, `group||${FilterComparator.EQUAL}||find-client`]}
