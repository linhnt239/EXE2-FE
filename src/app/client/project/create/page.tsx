            ...
            <div className="max-w-xl rounded-lg  border bg-white px-4 py-8 shadow-lg">
                <NKFormWrapper<UserMeSaleBookingIV1CreateDto>
                    ...
                    onExtraSuccessAction={(data) => {
                        ...
                        router.push(NKRouter.client.project.detail(data.id));
                    }}
                    defaultValues={{ description: '', extraFee: 0, imageUrls: [], name: '', price: 0, serviceCategoryId: '', group: 'find-client' }}
                    schema={{
                ...
                >
                    <div className="flex flex-col gap-4">
                        <div className=" text-center text-2xl font-semibold">Tạo dự án</div>
