                ...
                <section className="relative grid w-full grid-cols-4 gap-10  ">
                    <div className="col-span-1">
                        <div className="sticky left-0 top-32 flex w-full  flex-col items-center justify-center gap-4 rounded-lg  border border-[#4ade80] bg-green-50 px-2 py-6 shadow-lg">
                            <Link href={NKRouter.designer.detail(dataQuery.data?.user.id || '')} className="flex flex-col items-center gap-2">
                            ...
                            <ModalBuilder
                                modalTitle={<p className="mb-5 text-2xl font-semibold">Thuê Freelancer</p>}
                                ...
                                {(close) => (
                                    <NKFormWrapper<UserMeSaleBookingOrderIV1CreateDto>
                                        ...
                                        onExtraSuccessAction={(data) => {
                                            ...
                                            router.push(NKRouter.client.contact.detail(data.id));
                                            close();
                                        }}
                                    >
                                        <div className="flex flex-col gap-4">
                                            <p className="text-base font-medium text-gray-900">Freelancer: {dataQuery.data?.user.name}</p>
                                            ...
                                            <NKTextareaField name="clientNote" label="Ghi chú" />
                                            <ButtonC type="submit">Thuê ngay</ButtonC>
                                        </div>
                                    </NKFormWrapper>
                                )}
                            </ModalBuilder>
