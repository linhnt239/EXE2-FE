...
const Page: NextPage<PageProps> = () => {
    ...
    return (
        <>
            <div className="flex h-[calc(100vh-4.5rem)] w-full  flex-1 flex-col gap-4 overflow-y-auto">
                {!chat?.isSuccess ? (
                    <div className="flex flex-1 items-center justify-center">Loading...</div>
                ) : (
                    <>
                        <div className="fade-in fixed left-0 top-0 z-50 flex h-screen w-screen flex-col bg-white">
                            <div className="relative z-10 flex h-48 items-start justify-between gap-4 bg-gradient-to-tr from-blue-500 via-blue-400 to-indigo-600 p-4">
                                <Link href={NKRouter.app.chat.index()} className=" h-6  w-6 rounded-lg text-white">
                                    <div>
                            ...
                            <form className="relative z-50 w-full bg-gray-100 py-6">
                                <div className="relative flex w-full rounded-sm bg-white  px-4 py-4">
                                    ...
                                    <button
                                        ...
                                        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-indigo-700 text-2xl text-white"
                                    >
