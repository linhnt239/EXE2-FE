...
const Page: React.FunctionComponent<PageProps> = () => {
    ...
    const payMutation = useMutation(userMeSaleBookingOrderApi.v1Pay, {
        onSuccess: () => {
            ...
            userSaleBookingOrderQuery.refetch();
        },
        onError: (err: any) => {
        ...
        <div className="relative flex h-full w-full flex-col">
            <div className="relative flex h-full w-full flex-col">
                ...
                <div className="absolute right-4 top-4 z-10 flex gap-2">
                    {(userSaleBookingOrderQuery.data?.status === 'PENDING' || userSaleBookingOrderQuery.data?.status === 'CONFIRMED') && (
                        <ModalBuilder
                    ...
                    {userSaleBookingOrderQuery.data?.status === 'CONFIRMED' && (
                                ...
                                <Tab.Group>
                                    ...
                                    <Tab.Panels className={'h-full w-full pb-28  pt-5'}>
                                        <Tab.Panel className={'flex w-full flex-col gap-2'}>
                                            ...
                                            <div className="sm:col-span-2">
                                                <p className="text-base font-semibold text-gray-900">Mô tả của bạn:</p>
                                                <p className="text-base text-gray-900">
                                                    {userSaleBookingOrderQuery.data?.description || 'Không có mô tả'}
                                                </p>
                                            </div>
                                            <div className="sm:col-span-2">
                                                <p className="text-base font-semibold text-gray-900">Phản hồi từ người cung cấp: </p>
                                                <p className="text-base text-gray-900">
