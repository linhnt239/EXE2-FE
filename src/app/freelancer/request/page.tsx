        ...
        <div className="bg-white">
            <TableBuilder
                columns={[
                    {
                        ...
                        render: (record: UserSaleBookingOrder) => {
                            return <div className="text-blue-600 hover:text-blue-800">{record.user.name}</div>;
                        },
                    },

                    {
                        ...
                        render: (record: UserSaleBookingOrder) => {
                            ...
                            return (
                                <Link href={NKRouter.service.detail(record.id)} className="wtf text-blue-600 hover:text-blue-800">
                                    {name}
                                </Link>
                            );
                        },
...

                    {
                        ...
                        render: (record) => {
                            return (
                                <Link href={NKRouter.freelancer.request.detail(record.id)}>
                ...
                extraFilter={[
                    ...
                    `userSaleBooking.group||${FilterComparator.EQUAL}||freelance`,
                ]}
