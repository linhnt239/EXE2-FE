    ...
    return (
        <div className="bg-white">
            <TableBuilder
                columns={[
                    {
                        ...
                        render: (record: UserSaleBookingOrder) => {
                            ...
                            return <div className="text-blue-600 hover:text-blue-800">{name}</div>;
                        },
                    },
                    {
                        title: 'Tên dự án',
                        ...
                        render: (record: UserSaleBookingOrder) => {
                            ...
                            return (
                                <Link href={NKRouter.project.detail(record.userSaleBooking.id)} className="wtf text-blue-600 hover:text-blue-800">
                                    {name}
                                </Link>
                            );
                        },
                    ...
                    },
                    {
                        ...
                        render: (record) => {
                            return (
                                <Link href={NKRouter.freelancer.contact.detail(record.id)}>
                ...
                extraFilter={[`user.id||${FilterComparator.EQUAL}||${userState.id}`, `userSaleBooking.group||${FilterComparator.EQUAL}||find-client`]}
